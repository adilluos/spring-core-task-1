...
//import com.adilzhan.firsttask.service.inMemory.TraineeService;
...
//                new Trainee("Arman", "Babakov", "Arman.Babakov", "pass12310", true, LocalDate.of(2000, 12, 12), "id1", "Astana"),
//                new Trainee("Arman", "Babakov", "Arman.Babakov.1", "pass12310", true, LocalDate.of(2000, 12, 12), "id2", "Astana")
//        );
//
...
//        Trainee trainee = new Trainee("Arman", "Babakov", "Arman.Babakov", "pass12310", true, LocalDate.of(2000, 12, 12), "idid", "Astana");
//
...
//
//        assertNotNull(result);
//        assertEquals("idid", result.getId());
//    }
//
//    @Test
